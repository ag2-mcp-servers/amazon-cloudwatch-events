...
class EventPattern(RootModel[str]):
    root: str


class EventResource(RootModel[str]):
    root: str
...
class MessageGroupId(RootModel[str]):
    root: str
...
class Sql(RootModel[constr(min_length=1, max_length=100000)]):
